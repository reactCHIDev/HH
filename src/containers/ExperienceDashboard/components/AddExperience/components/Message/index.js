  ...
  return (
    <div className={styles.msg_container} style={{}}>
      <p className={styles.msg_text}>
        You are going to duplicate this product. You will be able to change the duplicate with no
        effect to the original product. Please, press “Duplicate” to proceed or “Cancel” to close
        this window
      </p>
