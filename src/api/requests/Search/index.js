...
export const searchByProductsReq = ({
  ...
  const params = `?${title}${explore}${cityId}${productTypeId}${price}${startIndex}${limit}`

  return apiClient.get(PATHS.searchInProducts + params)
} // ?title=new&cityId=2&explore=true&productTypeId=1&price=0,1000&startIndex=0&limit=12
